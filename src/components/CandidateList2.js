...
const CandidateList2 = ({match}) => {
    ...
    useEffect(()=>{
         getProject();
        //  console.log(match,"candidatelist ko");
    },[])
    ...
    return (
        <div className='projects'>
            ...
            <CandidateInfo ci_title={project.pName} ci_vid={project&& project.vDemo && project.vDemo.length ? getVideoId(project.vDemo).id:''}  ci_des={project.pDesc} ci_sub={project.submittedBy} ci_org={project.cName} urlPara={match}/>  
